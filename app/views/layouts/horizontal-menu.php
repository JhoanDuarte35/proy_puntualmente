        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="<?php echo controlador::$rutaAPP?>index.php?action=cerrar"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i>Cerrar Sesión</a>
