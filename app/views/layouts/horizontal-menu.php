        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.php" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Hk_P-plate.svg/600px-Hk_P-plate.svg.png" alt="" height="24"> <span class="logo-txt">Minia</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="<?php echo controlador::$rutaAPP?>/cerrar"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i>Cerrar Sesión</a>
