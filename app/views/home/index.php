...
<!-- Plugins js-->
<script src="<?php echo controlador::$rutaAPP?>app/assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>

<script src="<?php echo controlador::$rutaAPP?>app/assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>


<!-- dashboard init -->
<script src="<?php echo controlador::$rutaAPP?>app/assets/js/pages/dashboard.init.js"></script>
